...
//		the agents extracted and their main/useful characterists are stored, on the base of their species in .shp file, so not to load the osm file everytime
		save road format:"shp" to:"../includes/roads.shp" attributes:["lanes"::lanes,"maxspeed"::maxspeed, "oneway"::oneway, "junction"::junction] ;
		save intersection format:"shp" to:"../includes/nodes.shp" attributes:["type"::type, "crossing"::crossing] ;
		save building format: "shp" to:"../includes/buildings.shp" attributes:["type"::type, "group"::group] ;
