...
species decAV skills: [driving] control:fsm parent:cars{ 
...
//		}
	...
	aspect base {
		draw image_file("../includes/car-png-top-white-top-car-png-image-34867-587.png") size:{0.5#m,0.25#m} rotate: heading+180;
		draw breakdown ? square(5) : triangle(10) color: color rotate:heading + 90;
	} 
	aspect base3D {
