...
//		creation of the other cars with random parameters
	...
	action save_results {
			ask people {
				...
				save [name,arrival_time,start_work,time_late,waiting_time,got_lift,late_at_work_with_lift,cost_proposed] to: "people_data.csv" format: "csv" rewrite: false;
			}
			
			ask decAV {
				save [name,dist_covered_cars,gave_lift,cumulative_lifts_given] to: "AVs_data.csv" format: "csv" rewrite: false;
			}
		}
